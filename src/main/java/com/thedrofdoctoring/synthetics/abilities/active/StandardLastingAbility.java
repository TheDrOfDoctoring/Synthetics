...
public abstract class StandardLastingAbility extends LastingAbilityType<AbilityActiveInstance<?>> {
    ...
    public static AbilityActiveInstance.Data create(ActiveAbilityOptions options) {
        return new AbilityActiveInstance.Data(1.0d, options, Optional.empty(), Optional.empty());
    }
