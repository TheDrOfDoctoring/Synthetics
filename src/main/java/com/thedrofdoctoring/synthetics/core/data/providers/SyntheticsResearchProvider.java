    ...
    private static void createAugmentNodes(BootstrapContext<ResearchNode> context) {
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .unlocksAugments(
                                List.of(Augments.METABOLIC_CONVERTER, Augments.SYNTHETIC_LINING))
                        .experience(50)
                        .requiredItems(
                                List.of(
                                        Pair.of(Ingredient.of(Items.IRON_INGOT), 25),
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .parent(ResearchNodes.AUXILIARY_VIEWLINK)
                        .position(-60, -30)
                        .tab(ResearchNodes.TAB_AUGMENTS)
        );
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .experience(60)
                        .parent(ResearchNodes.HAND_FLAMETHROWER)
                        .requiredItems(
                                List.of(
                        ...
                        .position(above(ResearchNodes.HAND_FLAMETHROWER))
                        .tab(ResearchNodes.TAB_AUGMENTS)
        );
        register(context,
                ResearchNode.Builder.of(
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .experience(100)
                        .parent(ResearchNodes.TISSUE_AUGMENTS)
                        .requiredItems(
                                List.of(
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .position(offset(ResearchNodes.INTEGRATED_REDSTONE_LINK, -15, 30))
                        .parent(ResearchNodes.INTEGRATED_REDSTONE_LINK)
                        .tab(ResearchNodes.TAB_AUGMENTS)
        );
        register(context,
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .experience(150)
                        .parent(ResearchNodes.LINKED_TELEPORTER)
                        .requiredItems(
                                List.of(
                                        Pair.of(Ingredient.of(Items.ENDER_PEARL), 8),
                                        Pair.of(Ingredient.of(SyntheticsItems.BASIC_CIRCUIT.get()), 16),
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .position(above(ResearchNodes.HEART_BATTERY))
                        .tab(ResearchNodes.TAB_AUGMENTS)
        );
        register(context,
                ResearchNode.Builder.of(
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .position(above(ResearchNodes.SHOCK_ABSORBER))
                        .tab(ResearchNodes.TAB_AUGMENTS)
        );
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .position(above(ResearchNodes.DRONE_LINK))
                        .parent(ResearchNodes.DRONE_LINK)
                        .tab(ResearchNodes.TAB_AUGMENTS)
        );
        register(context,
                ResearchNode.Builder.of(
        ...
        register(context,
                ResearchNode.Builder.of(
                        ...
                        .parent(ResearchNodes.FEET_WALL_CLIMB)
                        .unlocksAugments(
